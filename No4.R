...
evaluateModels<-function(movieRatingMat){
  ...
  scheme <- evaluationScheme(movieRatingMat, method="cross-validation", train=.9, k=4, given=2, goodRating=2)
  algorithms<-list(
  ...
  results<-evaluate(scheme, algorithms[3], n=c(1,3,5,10,15,20))  
